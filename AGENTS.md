...
| `/autoresearch` | Autonomous propose→measure→keep loop: optimize an ML metric on a CPU-trainable model, or fan out researcher agents to keep improving a repo (test-verified fixes only). |
